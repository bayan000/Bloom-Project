...
class ProjectsController extends ChangeNotifier{
  ...
  Future<List<Project>> fetchProjects() async{
    ...
    return await ProjectsService.getProjects(//"admin/projects");//
        ServerConfig.getAllProjects);
  }
...
//DeleteProject------------------------------------------
  ...
  Future<List<Project>> SearchForProjectsByName(name) async{
    projectListSearched=await ProjectsService.searchForProject(ServerConfig.url+
        //"projects/Name/"
        ServerConfig.SearchForAProjectByName
        +
        name);
    print("name");
...
//DeleteProject------------------------------------------
  ...
  //SearchForProjectsByName------------------------------------
  Future<List<Project>> SearchForProjectsByName(name) async{
    projectListSearched=await ProjectsService.searchForProject(ServerConfig.url+"projects/Name/"+name);
    return projectListSearched;
  }
  //SearchForProjectsByAmount------------------------------------
  Future<List<Project>> SearchForProjectsByAmount(amount) async{
