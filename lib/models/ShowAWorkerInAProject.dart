class ShowAWorkerInAProject {
  Data? data;
  String? message;
  int? status;

  ShowAWorkerInAProject({this.data, this.message, this.status});

  ShowAWorkerInAProject.fromJson(Map<String, dynamic> json) {
